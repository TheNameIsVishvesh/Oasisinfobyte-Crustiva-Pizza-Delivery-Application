    ...
    <div class="min-h-[85vh] flex items-center justify-center px-6 py-12 bg-pizza-dark relative overflow-hidden">
      ...
      <div class="w-full max-w-md glass-dark p-8 rounded-[2rem] border border-white/5 shadow-premium text-white z-10">
        <div class="text-center space-y-2 mb-8">
          ...
          <p class="text-sm text-white/50">Enter credentials to order gourmet pizzas</p>
        </div>

        {/* Verification Alert Banner */}
        {isVerifiedQuery && (
          <div class="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 rounded-2xl flex items-start gap-3 text-xs leading-relaxed">
            <ShieldCheck class="w-5 h-5 shrink-0 text-emerald-400" />
            <div>
              <span class="font-bold block">Account Activated!</span>
        ...
        {error && (
          <div class="mb-6 p-4 bg-rose-500/10 border border-rose-500/20 text-rose-400 rounded-2xl flex items-start gap-3 text-xs leading-relaxed animate-shake">
            ...
            <div>
              <span class="font-bold block">Access Denied</span>
              {error}
            </div>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} class="space-y-5">
          ...
          <div class="space-y-1.5">
            <div class="flex justify-between items-center">
              ...
              <Link to="/forgot-password" class="text-xs text-pizza-accent hover:text-pizza-primary transition-colors">Forgot Password?</Link>
            </div>
            <div class="relative">
        ...
        <div class="text-center mt-6 pt-6 border-t border-white/5 text-xs text-white/40 space-y-4">
          <p>
