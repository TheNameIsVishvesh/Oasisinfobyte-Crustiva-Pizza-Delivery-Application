      ...
      <div className="max-w-6xl mx-auto space-y-8 z-10 relative">
        ...
        {orders.length === 0 ? (
          <div className="text-center py-20 bg-white/5 rounded-3xl border border-dashed border-white/10 text-white/40 space-y-3">
            ...
            <p className="text-sm">No orders registered in the pizzeria network yet.</p>
          </div>
        ) : (
          <div className="space-y-6">
            {orders.map((order) => (
              ...
              >
                {/* Header */}
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-white/5 pb-4 text-xs">
                  <div>
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-xl font-black text-pizza-accent">₹{order.totalAmount}</span>
                    </div>
                  </div>
                </div>
                      ...
                      <div key={idx} className="bg-white/5 rounded-2xl p-4 border border-white/5 text-xs space-y-2">
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <span className="text-[10px] text-pizza-accent font-bold bg-pizza-accent/10 px-2 py-0.5 rounded-full ml-2">
                              {item.size}
                            </span>
                          </div>
